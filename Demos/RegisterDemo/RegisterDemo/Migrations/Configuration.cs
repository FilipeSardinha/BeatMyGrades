...
using System.Linq;
using RegisterDemo.Models;
using Microsoft.AspNet.Identity;

namespace RegisterDemo.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        private const string InitialUserName = "Filipe";
        private const string InitialUserFirstName = "Filipe";
        private const string InitialUserLastName = "Sardinha";
        private const string InitialUserEmail = "filipe.sardinha1@gmail.com";
        private const string InitialUserPassword = "123456";

        private const string VaniallaUserName = "test";
        private const string VaniallaUserFirstName = "teste";
        private const string VaniallaUserLastName = "simples";
        private const string VaniallaUserEmail = "test@test.com";
        private const string VaniallaUserPassword = "123456";
        ...
        private void AddUsers()
        {
            ...
            {
                // warn the user that it's seeding went wrong
                throw new DbEntityValidationException("Could not create User because: " + String.Join(", ", userCreationResult.Errors));
            }
        }
